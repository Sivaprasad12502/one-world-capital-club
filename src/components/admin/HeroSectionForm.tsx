    ...
    >
      ...
      <label>
        ...
        <input
          ...
          placeholder="e.g. Premier UAE Free Zone Operations"
        />
        {errors.badge ? <p className="admin-field-error">{errors.badge.message}</p> : null}
      </label>
      ...
      <div className="hero-section-form__actions">
        ...
        <div>
          ...
          <label>
            Label
            <input {...register("secondaryLabel")} placeholder="Explore Services" />
          </label>
          <label>
            Href
